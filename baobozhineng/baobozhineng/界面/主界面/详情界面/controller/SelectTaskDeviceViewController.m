...
@interface SelectTaskDeviceViewController ()<UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout>
{
...
@implementation SelectTaskDeviceViewController
